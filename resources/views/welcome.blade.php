...
<body>
    ...
    <section class="hero" id="home">
        ...
        <div class="container hero-content">
            ...
            <div class="hero-meta">
                <span><i class="far fa-clock"></i> Tue – Sun &nbsp;·&nbsp; 11:00 – 21:00</span>
            </div>
                ...
                <form class="booking-form" id="bookingForm" action="{{ route('booking.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="service" id="serviceSelect" required>
                                ...
                                <option value="Haircut" data-price="50000" {{ old('service') == 'Haircut' ? 'selected' : '' }}>Haircut – Rp 50.000</option>
                                <option value="Beard Trim" data-price="50000" {{ old('service') == 'Beard Trim' ? 'selected' : '' }}>Beard Trim – Rp 50.000</option>
                                <option value="Hair Wash" data-price="25000" {{ old('service') == 'Hair Wash' ? 'selected' : '' }}>Hair Wash – Rp 25.000</option>
                                <option value="Hair Color" data-price="200000" {{ old('service') == 'Hair Color' ? 'selected' : '' }}>Hair Color – Rp 200.000</option>
                                <option value="Perming" data-price="200000" {{ old('service') == 'Perming' ? 'selected' : '' }}>Perming – Rp 200.000</option>
                            </select>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="time" required>
                                ...
                                @foreach(['09:00','10:00','11:00','12:00','13:00','14:00','15:00','16:00','17:00','18:00'] as $t)
                    ...
                    <div class="booking-summary" id="bookingSummary" style="display:none;">
                        <div class="summary-row">
                            <span>Service</span><span id="summaryService">–</span>
                        </div>
    ...
    <section class="schedule section" id="schedule">
        <div class="container">
            ...
            <div class="schedule-filter">
                ...
                <div class="filter-group">
                    <label><i class="fas fa-cut"></i> Caster</label>
                    <select id="filterBarber">
                        <option value="">All Caster</option>
    ...
    <script>
        ...
        // ── Service select → show summary ────────────────────────
        document.getElementById('serviceSelect').addEventListener('change', function() {
            const opt = this.options[this.selectedIndex];
            const price = opt.dataset.price;
            const summary = document.getElementById('bookingSummary');
            if (price) {
                document.getElementById('summaryService').textContent = opt.text;
                document.getElementById('summaryPrice').textContent = 'Rp ' + parseInt(price).toLocaleString('id-ID');
